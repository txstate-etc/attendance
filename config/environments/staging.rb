Attendance::Application.configure do
  ...
  config.action_mailer.default_url_options = { :host => "attendance.staging.its.txstate.edu" }

  # Configure the ExceptionNotification gem
  config.middleware.use ExceptionNotification::Rack,
    :email => {
      :email_prefix => "[attendance-staging] ",
      :sender_address => %{"Attendance Error" <nobody@txstate.edu>},
      :exception_recipients => %w{crs142@txstate.edu nw13@txstate.edu ct37@txstate.edu},
